...
Here is an example of the JSON I expect back:${sampleObject2}\nI will process your response through a JSON.decode(), so only reply with valid JSON in the form provided. Be sure to include at least 4 frames in the output, up to a max of 12. Prompt: 
`
